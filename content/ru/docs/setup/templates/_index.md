...
Шаблоны служат:
- [Для написания и выполнения скриптов через транспорты SSH и HTTP]({{< ref "/docs/setup/templates/scripts" >}})
- [Для отправки уведомлений клиентам (email, telegram...)]({{< ref "/docs/setup/templates/notifications" >}})
- [Для написания Telegram bot-ов]({{< ref "/docs/setup/templates/telegram_bot" >}})
- [Для выполнения различных задач автоматизации]({{< ref "/docs/setup/templates/jobs" >}})
- Для отображения данных в кабинете пользователей
- Для произвольных данных (HTML страницы по ссылке)
